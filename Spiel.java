public class Spiel {
  ...
  private List<Raum> raumAktionen = new List<Raum>();
  private List<Gegner> gegnerAktionen = new List<Gegner>();
  private List<NPC> charakterAktionen = new List<NPC>();
  ...
  public Spiel(String pSpielerName) {
   ...
   Gegenstand[] raumBelohnung = {
    ...
    String[][] gegnerBeschreibungen = {
      ...
      {}, //2. Neubau
      {
        "Unbesiegbare Wand! Lauf um dein Leben."
      }, //3. Sporthalle
      {
    ...
    Waffe[][] gegnerWaffen = {
      ...
      {
        new Waffe("Taktstock des Grauens", "Lass dich nicht stressen", 5)
      }, //5. Aula
      {}, //6. Mensa
      {}, //7. Schulhof 2
      {}, //8. Pavillion
    ...
    Ruestung[][] gegnerRuestungen = {
      ...
      {}, //2. Neubau
      {
        new Ruestung("Jogging Anzug", "Sieht direkt noch gefaehrlicher aus ", 100000)
      }, //3. Sporthalle
      {
      ...
      {
        new Ruestung("Unbezahlbarer Anzug", "Schicker Anzug der fuer Geringverdiener unbezahlbar wirkt", 0);
      }, //5. Aula
      {}, //6. Mensa
      {}, //7. Schulhof 2
      {}, //8. Pavillion
  ...
  public List<String> gibAktionen() {
    ...
    for(int i = 0; i < aktuellerRaum.gibNachbarn().length; i++) {
      raumAktionen.append(aktuellerRaum.gibNachbarn()[i]);
      aktionen.append("Gehe in " + aktuellerRaum.gibNachbarn()[i] + ".");
    }
    gegnerAktionen = aktuellerRaum.gibGegner();
    gegnerAktionen.toFirst();
    while(gegnerAktionen.hasAccess()) {
      aktionen.append("Greife " + gegner.getContent().gibName() + " an.");
      gegnerAktionen.next();
    }
    charakterAktionen = aktuellerRaum.gibCharaktere();
    charakterAktionen.toFirst();
    while(charakterAktionen.hasAccess()) {
      aktionen.append("Sprich mit " + charakterAktionen.getContent().gibName() + ".");
      charakterAktionen.next();
    }
  ...
  public void aktion(String aktion) {
    switch(aktion) {
